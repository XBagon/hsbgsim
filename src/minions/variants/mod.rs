...
impl MinionVariant {
    ...
    pub fn golden_event_handlers(self) -> EventHandlers {
        match self {
            MinionVariant::Invalid => panic!("Invalid MinionVariant"),
            MinionVariant::Alleycat => alleycat::golden_event_handlers(),
            MinionVariant::AnnoyOTron => annoy_o_tron::golden_event_handlers(),
            MinionVariant::Bubblette => bubblette::golden_event_handlers(),
            MinionVariant::DeckSwabbie => deck_swabbie::golden_event_handlers(),
            MinionVariant::DozyWhelp => dozy_whelp::golden_event_handlers(),
            MinionVariant::EvolvingChromawing => evolving_chromawing::golden_event_handlers(),
            MinionVariant::IckyImp => icky_imp::golden_event_handlers(),
            MinionVariant::Imprisoner => imprisoner::golden_event_handlers(),
            MinionVariant::IncorporealCorporal => incorporeal_corporal::golden_event_handlers(),
            MinionVariant::Manasaber => manasaber::golden_event_handlers(),
            MinionVariant::MicroMummy => micro_mummy::golden_event_handlers(),
            MinionVariant::MiniMyrmidon => mini_myrmidon::golden_event_handlers(),
            MinionVariant::Mistake => mistake::golden_event_handlers(),
            MinionVariant::PickyEater => picky_eater::golden_event_handlers(),
            MinionVariant::Pupbot => pupbot::golden_event_handlers(),
            MinionVariant::RazorfenGeomancer => razorfen_geomancer::golden_event_handlers(),
            MinionVariant::RedWhelp => red_whelp::golden_event_handlers(),
            MinionVariant::RefreshingAnomaly => refreshing_anomaly::golden_event_handlers(),
            MinionVariant::RisenRider => risen_rider::golden_event_handlers(),
            MinionVariant::RockpoolHunter => rockpool_hunter::golden_event_handlers(),
            MinionVariant::RotHideGnoll => rot_hide_gnoll::golden_event_handlers(),
            MinionVariant::Scallywag => scallywag::golden_event_handlers(),
            MinionVariant::ScavengingHyena => scavenging_hyena::golden_event_handlers(),
            MinionVariant::Sellemental => sellemental::golden_event_handlers(),
            MinionVariant::ShellCollector => shell_collector::golden_event_handlers(),
            MinionVariant::SilverbackPatriarch => silverback_patriarch::golden_event_handlers(),
            MinionVariant::SouthseaBusker => southsea_busker::golden_event_handlers(),
            MinionVariant::SunBaconRelaxer => sun_bacon_relaxer::golden_event_handlers(),
            MinionVariant::SurfNSurf => surf_n_surf::golden_event_handlers(),
            MinionVariant::Swampstriker => swampstriker::golden_event_handlers(),
            MinionVariant::TavernTipper => tavern_tipper::golden_event_handlers(),
            MinionVariant::Thorncaptain => thorncaptain::golden_event_handlers(),
            MinionVariant::UpbeatFrontdrake => upbeat_frontdrake::golden_event_handlers(),
            MinionVariant::WrathWeaver => wrath_weaver::golden_event_handlers(),
            MinionVariant::AcolyteOfCThun => acolyte_of_c_thun::golden_event_handlers(),
            MinionVariant::BackstageSecurity => backstage_security::golden_event_handlers(),
            MinionVariant::BejeweledDuelist => bejeweled_duelist::golden_event_handlers(),
            MinionVariant::BlazingSkyfin => blazing_skyfin::golden_event_handlers(),
            MinionVariant::BriarbackBookie => briarback_bookie::golden_event_handlers(),
            MinionVariant::CogworkCopter => cogwork_copter::golden_event_handlers(),
            MinionVariant::CorpseRefiner => corpse_refiner::golden_event_handlers(),
            MinionVariant::DeepSeaAngler => deep_sea_angler::golden_event_handlers(),
            MinionVariant::EternalKnight => eternal_knight::golden_event_handlers(),
            MinionVariant::FlourishingFrostling => flourishing_frostling::golden_event_handlers(),
            MinionVariant::FreedealingGambler => freedealing_gambler::golden_event_handlers(),
            MinionVariant::GlyphGuardian => glyph_guardian::golden_event_handlers(),
            MinionVariant::HarvestGolem => harvest_golem::golden_event_handlers(),
            MinionVariant::HummingBird => humming_bird::golden_event_handlers(),
            MinionVariant::HungrySnapjaw => hungry_snapjaw::golden_event_handlers(),
            MinionVariant::ImpulsiveTrickster => impulsive_trickster::golden_event_handlers(),
            MinionVariant::InventOMatic => invent_o_matic::golden_event_handlers(),
            MinionVariant::KaboomBot => kaboom_bot::golden_event_handlers(),
            MinionVariant::KookyChemist => kooky_chemist::golden_event_handlers(),
            MinionVariant::LavaLurker => lava_lurker::golden_event_handlers(),
            MinionVariant::Leapfrogger => leapfrogger::golden_event_handlers(),
            MinionVariant::LowFlier => low_flier::golden_event_handlers(),
            MinionVariant::Lullabot => lullabot::golden_event_handlers(),
            MinionVariant::MenagerieMug => menagerie_mug::golden_event_handlers(),
            MinionVariant::MetaltoothLeaper => metaltooth_leaper::golden_event_handlers(),
            MinionVariant::MindMuck => mind_muck::golden_event_handlers(),
            MinionVariant::MoltenRock => molten_rock::golden_event_handlers(),
            MinionVariant::Murcules => murcules::golden_event_handlers(),
            MinionVariant::MurlocWarleader => murloc_warleader::golden_event_handlers(),
            MinionVariant::NathrezimOverseer => nathrezim_overseer::golden_event_handlers(),
            MinionVariant::NerubianDeathswarmer => nerubian_deathswarmer::golden_event_handlers(),
            MinionVariant::OozelingGladiator => oozeling_gladiator::golden_event_handlers(),
            MinionVariant::PatientScout => patient_scout::golden_event_handlers(),
            MinionVariant::PiggybackImp => piggyback_imp::golden_event_handlers(),
            MinionVariant::PoeticPenPal => poetic_pen_pal::golden_event_handlers(),
            MinionVariant::ProphetOfTheBoar => prophet_of_the_boar::golden_event_handlers(),
            MinionVariant::RabidSaurolisk => rabid_saurolisk::golden_event_handlers(),
            MinionVariant::ReefRiffer => reef_riffer::golden_event_handlers(),
            MinionVariant::RipsnarlCaptain => ripsnarl_captain::golden_event_handlers(),
            MinionVariant::Roadboar => roadboar::golden_event_handlers(),
            MinionVariant::SaltscaleHoncho => saltscale_honcho::golden_event_handlers(),
            MinionVariant::ScarletSkull => scarlet_skull::golden_event_handlers(),
            MinionVariant::SeabornSummoner => seaborn_summoner::golden_event_handlers(),
            MinionVariant::SelflessHero => selfless_hero::golden_event_handlers(),
            MinionVariant::SewerRat => sewer_rat::golden_event_handlers(),
            MinionVariant::SnailCavalry => snail_cavalry::golden_event_handlers(),
            MinionVariant::SoulRewinder => soul_rewinder::golden_event_handlers(),
            MinionVariant::SouthseaCaptain => southsea_captain::golden_event_handlers(),
            MinionVariant::SparringPartner => sparring_partner::golden_event_handlers(),
            MinionVariant::SpawnOfNZoth => spawn_of_n_zoth::golden_event_handlers(),
            MinionVariant::StewardOfTime => steward_of_time::golden_event_handlers(),
            MinionVariant::Tad => tad::golden_event_handlers(),
            MinionVariant::Thorncaller => thorncaller::golden_event_handlers(),
            MinionVariant::ToughTusk => tough_tusk::golden_event_handlers(),
            MinionVariant::TwilightEmissary => twilight_emissary::golden_event_handlers(),
            MinionVariant::UnstableGhoul => unstable_ghoul::golden_event_handlers(),
            MinionVariant::UpbeatFlutist => upbeat_flutist::golden_event_handlers(),
            MinionVariant::WhelpSmuggler => whelp_smuggler::golden_event_handlers(),
            MinionVariant::YoHoOgre => yo_ho_ogre::golden_event_handlers(),
            MinionVariant::Yrel => yrel::golden_event_handlers(),
            MinionVariant::AccordOTron => accord_o_tron::golden_event_handlers(),
            MinionVariant::AmberGuardian => amber_guardian::golden_event_handlers(),
            MinionVariant::ArmOfTheEmpire => arm_of_the_empire::golden_event_handlers(),
            MinionVariant::BirdBuddy => bird_buddy::golden_event_handlers(),
            MinionVariant::BloodsailCannoneer => bloodsail_cannoneer::golden_event_handlers(),
            MinionVariant::BrinyBootlegger => briny_bootlegger::golden_event_handlers(),
            MinionVariant::BristlebackBrute => bristleback_brute::golden_event_handlers(),
            MinionVariant::BristlemaneScrapsmith => bristlemane_scrapsmith::golden_event_handlers(),
            MinionVariant::BronzeWarden => bronze_warden::golden_event_handlers(),
            MinionVariant::BuddingGreenthumb => budding_greenthumb::golden_event_handlers(),
            MinionVariant::ColdlightSeer => coldlight_seer::golden_event_handlers(),
            MinionVariant::CracklingCyclone => crackling_cyclone::golden_event_handlers(),
            MinionVariant::DaggerspineThrasher => daggerspine_thrasher::golden_event_handlers(),
            MinionVariant::DeflectOBot => deflect_o_bot::golden_event_handlers(),
            MinionVariant::Dreadbeard => dreadbeard::golden_event_handlers(),
            MinionVariant::EventideBrute => eventide_brute::golden_event_handlers(),
            MinionVariant::FacelessDisciple => faceless_disciple::golden_event_handlers(),
            MinionVariant::Felemental => felemental::golden_event_handlers(),
            MinionVariant::FelfinNavigator => felfin_navigator::golden_event_handlers(),
            MinionVariant::FirstMatePip => first_mate_pip::golden_event_handlers(),
            MinionVariant::FreeFlyingFeathermane => {
                free_flying_feathermane::golden_event_handlers()
            }
            MinionVariant::Gemsplitter => gemsplitter::golden_event_handlers(),
            MinionVariant::GhoulOfTheFeast => ghoul_of_the_feast::golden_event_handlers(),
            MinionVariant::GunpowderCourier => gunpowder_courier::golden_event_handlers(),
            MinionVariant::HandlessForsaken => handless_forsaken::golden_event_handlers(),
            MinionVariant::Houndmaster => houndmaster::golden_event_handlers(),
            MinionVariant::IronGroundskeeper => iron_groundskeeper::golden_event_handlers(),
            MinionVariant::IronSensei => iron_sensei::golden_event_handlers(),
            MinionVariant::JellyBelly => jelly_belly::golden_event_handlers(),
            MinionVariant::KathraNatir => kathra_natir::golden_event_handlers(),
            MinionVariant::KeyboardIgniter => keyboard_igniter::golden_event_handlers(),
            MinionVariant::Khadgar => khadgar::golden_event_handlers(),
            MinionVariant::LeechingFelhound => leeching_felhound::golden_event_handlers(),
            MinionVariant::LegionOverseer => legion_overseer::golden_event_handlers(),
            MinionVariant::LichDoctor => lich_doctor::golden_event_handlers(),
            MinionVariant::LivingConstellation => living_constellation::golden_event_handlers(),
            MinionVariant::MonstrousMacaw => monstrous_macaw::golden_event_handlers(),
            MinionVariant::MoonBaconJazzer => moon_bacon_jazzer::golden_event_handlers(),
            MinionVariant::NetherDrake => nether_drake::golden_event_handlers(),
            MinionVariant::NightmareAmalgam => nightmare_amalgam::golden_event_handlers(),
            MinionVariant::PartyElemental => party_elemental::golden_event_handlers(),
            MinionVariant::PashmarTheVengeful => pashmar_the_vengeful::golden_event_handlers(),
            MinionVariant::PricklyPiper => prickly_piper::golden_event_handlers(),
            MinionVariant::Pufferquil => pufferquil::golden_event_handlers(),
            MinionVariant::RadioStar => radio_star::golden_event_handlers(),
            MinionVariant::RatPack => rat_pack::golden_event_handlers(),
            MinionVariant::RecyclingWraith => recycling_wraith::golden_event_handlers(),
            MinionVariant::RelentlessSentry => relentless_sentry::golden_event_handlers(),
            MinionVariant::ReplicatingMenace => replicating_menace::golden_event_handlers(),
            MinionVariant::SaltyLooter => salty_looter::golden_event_handlers(),
            MinionVariant::Scourfin => scourfin::golden_event_handlers(),
            MinionVariant::ScrewjankClunker => screwjank_clunker::golden_event_handlers(),
            MinionVariant::ShifterZerus => shifter_zerus::golden_event_handlers(),
            MinionVariant::ShoalCommander => shoal_commander::golden_event_handlers(),
            MinionVariant::Smogger => smogger::golden_event_handlers(),
            MinionVariant::SoreLoser => sore_loser::golden_event_handlers(),
            MinionVariant::SoulDevourer => soul_devourer::golden_event_handlers(),
            MinionVariant::SoulJuggler => soul_juggler::golden_event_handlers(),
            MinionVariant::SouthseaStrongarm => southsea_strongarm::golden_event_handlers(),
            MinionVariant::SparkLing => spark_ling::golden_event_handlers(),
            MinionVariant::StasisElemental => stasis_elemental::golden_event_handlers(),
            MinionVariant::Swolefin => swolefin::golden_event_handlers(),
            MinionVariant::Tarecgosa => tarecgosa::golden_event_handlers(),
            MinionVariant::TheGladIator => the_glad_iator::golden_event_handlers(),
            MinionVariant::TimeSaver => time_saver::golden_event_handlers(),
            MinionVariant::WardenOfOld => warden_of_old::golden_event_handlers(),
            MinionVariant::WitheredSpearhide => withered_spearhide::golden_event_handlers(),
            MinionVariant::ZestyShaker => zesty_shaker::golden_event_handlers(),
            MinionVariant::AnnihilanBattlemaster => annihilan_battlemaster::golden_event_handlers(),
            MinionVariant::AnnoyOModule => annoy_o_module::golden_event_handlers(),
            MinionVariant::AnubArakNerubianKing => anub_arak_nerubian_king::golden_event_handlers(),
            MinionVariant::Atramedes => atramedes::golden_event_handlers(),
            MinionVariant::BallOfMinions => ball_of_minions::golden_event_handlers(),
            MinionVariant::BananaSlamma => banana_slamma::golden_event_handlers(),
            MinionVariant::Bannerboar => bannerboar::golden_event_handlers(),
            MinionVariant::Bassgill => bassgill::golden_event_handlers(),
            MinionVariant::Bigfernal => bigfernal::golden_event_handlers(),
            MinionVariant::BladeCollector => blade_collector::golden_event_handlers(),
            MinionVariant::Bonker => bonker::golden_event_handlers(),
            MinionVariant::BreamCounter => bream_counter::golden_event_handlers(),
            MinionVariant::CarbonicCopy => carbonic_copy::golden_event_handlers(),
            MinionVariant::CaveHydra => cave_hydra::golden_event_handlers(),
            MinionVariant::ChampionOfYShaarj => champion_of_y_shaarj::golden_event_handlers(),
            MinionVariant::CobaltScalebane => cobalt_scalebane::golden_event_handlers(),
            MinionVariant::DancingBarnstormer => dancing_barnstormer::golden_event_handlers(),
            MinionVariant::DazzlingLightspawn => dazzling_lightspawn::golden_event_handlers(),
            MinionVariant::DeepBlueCrooner => deep_blue_crooner::golden_event_handlers(),
            MinionVariant::DefenderOfArgus => defender_of_argus::golden_event_handlers(),
            MinionVariant::DrakonidEnforcer => drakonid_enforcer::golden_event_handlers(),
            MinionVariant::DynamicDuo => dynamic_duo::golden_event_handlers(),
            MinionVariant::EelboundArcher => eelbound_archer::golden_event_handlers(),
            MinionVariant::ElectricSynthesizer => electric_synthesizer::golden_event_handlers(),
            MinionVariant::EmergentFlame => emergent_flame::golden_event_handlers(),
            MinionVariant::FairyTaleCaroler => fairy_tale_caroler::golden_event_handlers(),
            MinionVariant::FireworksFanatic => fireworks_fanatic::golden_event_handlers(),
            MinionVariant::FloatingWatcher => floating_watcher::golden_event_handlers(),
            MinionVariant::GemSmuggler => gem_smuggler::golden_event_handlers(),
            MinionVariant::Goldgrubber => goldgrubber::golden_event_handlers(),
            MinionVariant::Groundshaker => groundshaker::golden_event_handlers(),
            MinionVariant::ImpatientDoomsayer => impatient_doomsayer::golden_event_handlers(),
            MinionVariant::ImposingPercussionist => imposing_percussionist::golden_event_handlers(),
            MinionVariant::LovesickBalladist => lovesick_balladist::golden_event_handlers(),
            MinionVariant::MajordomoExecutus => majordomo_executus::golden_event_handlers(),
            MinionVariant::MalchezaarPrinceOfDance => {
                malchezaar_prince_of_dance::golden_event_handlers()
            }
            MinionVariant::MasterOfRealities => master_of_realities::golden_event_handlers(),
            MinionVariant::MechanoEgg => mechano_egg::golden_event_handlers(),
            MinionVariant::MechanoTank => mechano_tank::golden_event_handlers(),
            MinionVariant::MenagerieJug => menagerie_jug::golden_event_handlers(),
            MinionVariant::Necrolyte => necrolyte::golden_event_handlers(),
            MinionVariant::PeckishFeldrake => peckish_feldrake::golden_event_handlers(),
            MinionVariant::PeggyBrittlebone => peggy_brittlebone::golden_event_handlers(),
            MinionVariant::PeggySturdybone => peggy_sturdybone::golden_event_handlers(),
            MinionVariant::PlaguedTidewalker => plagued_tidewalker::golden_event_handlers(),
            MinionVariant::PossessiveBanshee => possessive_banshee::golden_event_handlers(),
            MinionVariant::PrestorSPyrospawn => prestor_s_pyrospawn::golden_event_handlers(),
            MinionVariant::PrimalfinLookout => primalfin_lookout::golden_event_handlers(),
            MinionVariant::PrizedPromoDrake => prized_promo_drake::golden_event_handlers(),
            MinionVariant::QirajiHarbinger => qiraji_harbinger::golden_event_handlers(),
            MinionVariant::ReanimatingRattler => reanimating_rattler::golden_event_handlers(),
            MinionVariant::ReefExplorer => reef_explorer::golden_event_handlers(),
            MinionVariant::RendleTheMistermind => rendle_the_mistermind::golden_event_handlers(),
            MinionVariant::RingMatron => ring_matron::golden_event_handlers(),
            MinionVariant::RylakMetalhead => rylak_metalhead::golden_event_handlers(),
            MinionVariant::SavannahHighmane => savannah_highmane::golden_event_handlers(),
            MinionVariant::ScrapScraper => scrap_scraper::golden_event_handlers(),
            MinionVariant::SilentSwimmer => silent_swimmer::golden_event_handlers(),
            MinionVariant::SinDoreiStraightShot => sin_dorei_straight_shot::golden_event_handlers(),
            MinionVariant::SlyRaptor => sly_raptor::golden_event_handlers(),
            MinionVariant::Soulsplitter => soulsplitter::golden_event_handlers(),
            MinionVariant::Stormbringer => stormbringer::golden_event_handlers(),
            MinionVariant::StrongshellScavenger => strongshell_scavenger::golden_event_handlers(),
            MinionVariant::TreasureSeekerElise => treasure_seeker_elise::golden_event_handlers(),
            MinionVariant::TunnelBlaster => tunnel_blaster::golden_event_handlers(),
            MinionVariant::UpbeatUpstart => upbeat_upstart::golden_event_handlers(),
            MinionVariant::VigilantStoneborn => vigilant_stoneborn::golden_event_handlers(),
            MinionVariant::Wargear => wargear::golden_event_handlers(),
            MinionVariant::Waverider => waverider::golden_event_handlers(),
            MinionVariant::WildfireElemental => wildfire_elemental::golden_event_handlers(),
            MinionVariant::WitchwingNestmatron => witchwing_nestmatron::golden_event_handlers(),
            MinionVariant::XyloBones => xylo_bones::golden_event_handlers(),
            MinionVariant::AdaptableBarricade => adaptable_barricade::golden_event_handlers(),
            MinionVariant::AgamagganTheGreatBoar => {
                agamaggan_the_great_boar::golden_event_handlers()
            }
            MinionVariant::AggemThorncurse => aggem_thorncurse::golden_event_handlers(),
            MinionVariant::AnnoyOTroupe => annoy_o_troupe::golden_event_handlers(),
            MinionVariant::BabyKrush => baby_krush::golden_event_handlers(),
            MinionVariant::BaronRivendare => baron_rivendare::golden_event_handlers(),
            MinionVariant::Bonemare => bonemare::golden_event_handlers(),
            MinionVariant::BongoBopper => bongo_bopper::golden_event_handlers(),
            MinionVariant::BrannBronzebeard => brann_bronzebeard::golden_event_handlers(),
            MinionVariant::BristlebackKnight => bristleback_knight::golden_event_handlers(),
            MinionVariant::CapNHoggarr => cap_n_hoggarr::golden_event_handlers(),
            MinionVariant::ChampionOfThePrimus => champion_of_the_primus::golden_event_handlers(),
            MinionVariant::Chronormu => chronormu::golden_event_handlers(),
            MinionVariant::CorruptedMyrmidon => corrupted_myrmidon::golden_event_handlers(),
            MinionVariant::CritterWrangler => critter_wrangler::golden_event_handlers(),
            MinionVariant::CyborgDrake => cyborg_drake::golden_event_handlers(),
            MinionVariant::DeadlySpore => deadly_spore::golden_event_handlers(),
            MinionVariant::DiscoShuffler => disco_shuffler::golden_event_handlers(),
            MinionVariant::DrBoombox => dr_boombox::golden_event_handlers(),
            MinionVariant::DrakkariEnchanter => drakkari_enchanter::golden_event_handlers(),
            MinionVariant::FriendOfAFriend => friend_of_a_friend::golden_event_handlers(),
            MinionVariant::GeneralDrakkisath => general_drakkisath::golden_event_handlers(),
            MinionVariant::Glowscale => glowscale::golden_event_handlers(),
            MinionVariant::GustyTrumpeter => gusty_trumpeter::golden_event_handlers(),
            MinionVariant::HolyMecherel => holy_mecherel::golden_event_handlers(),
            MinionVariant::HungeringAbomination => hungering_abomination::golden_event_handlers(),
            MinionVariant::HunterOfGatherers => hunter_of_gatherers::golden_event_handlers(),
            MinionVariant::InsatiableUrZul => insatiable_ur_zul::golden_event_handlers(),
            MinionVariant::InterrogatorWhitemane => interrogator_whitemane::golden_event_handlers(),
            MinionVariant::KangorSApprentice => kangor_s_apprentice::golden_event_handlers(),
            MinionVariant::KingBagurgle => king_bagurgle::golden_event_handlers(),
            MinionVariant::LeeroyTheReckless => leeroy_the_reckless::golden_event_handlers(),
            MinionVariant::LightfangEnforcer => lightfang_enforcer::golden_event_handlers(),
            MinionVariant::LilRag => lil_rag::golden_event_handlers(),
            MinionVariant::Magmaloc => magmaloc::golden_event_handlers(),
            MinionVariant::MamaBear => mama_bear::golden_event_handlers(),
            MinionVariant::Mannoroth => mannoroth::golden_event_handlers(),
            MinionVariant::MechanizedGiftHorse => mechanized_gift_horse::golden_event_handlers(),
            MinionVariant::Murozond => murozond::golden_event_handlers(),
            MinionVariant::MythraxTheUnraveler => mythrax_the_unraveler::golden_event_handlers(),
            MinionVariant::Niuzao => niuzao::golden_event_handlers(),
            MinionVariant::NomiKitchenNightmare => nomi_kitchen_nightmare::golden_event_handlers(),
            MinionVariant::OperaticBelcher => operatic_belcher::golden_event_handlers(),
            MinionVariant::PalescaleCrocolisk => palescale_crocolisk::golden_event_handlers(),
            MinionVariant::RazorgoreTheUntamed => razorgore_the_untamed::golden_event_handlers(),
            MinionVariant::RecordSmuggler => record_smuggler::golden_event_handlers(),
            MinionVariant::SanctumRester => sanctum_rester::golden_event_handlers(),
            MinionVariant::SiSefin => si_sefin::golden_event_handlers(),
            MinionVariant::SinrunnerBlanchy => sinrunner_blanchy::golden_event_handlers(),
            MinionVariant::StormscaleSiren => stormscale_siren::golden_event_handlers(),
            MinionVariant::TavernTempest => tavern_tempest::golden_event_handlers(),
            MinionVariant::Tichondrius => tichondrius::golden_event_handlers(),
            MinionVariant::TitusRivendare => titus_rivendare::golden_event_handlers(),
            MinionVariant::TonyTwoTusk => tony_two_tusk::golden_event_handlers(),
            MinionVariant::TortollanBlueShell => tortollan_blue_shell::golden_event_handlers(),
            MinionVariant::Toxfin => toxfin::golden_event_handlers(),
            MinionVariant::TransmutedBramblewitch => {
                transmuted_bramblewitch::golden_event_handlers()
            }
            MinionVariant::UnderhandedDealer => underhanded_dealer::golden_event_handlers(),
            MinionVariant::UpbeatDuo => upbeat_duo::golden_event_handlers(),
            MinionVariant::UpbeatImpressionist => upbeat_impressionist::golden_event_handlers(),
            MinionVariant::UtilityDrone => utility_drone::golden_event_handlers(),
            MinionVariant::VanessaVanCleef => vanessa_van_cleef::golden_event_handlers(),
            MinionVariant::Voidlord => voidlord::golden_event_handlers(),
            MinionVariant::ArchdruidHamuul => archdruid_hamuul::golden_event_handlers(),
            MinionVariant::Bristlebach => bristlebach::golden_event_handlers(),
            MinionVariant::CaptainFlatTusk => captain_flat_tusk::golden_event_handlers(),
            MinionVariant::Charlga => charlga::golden_event_handlers(),
            MinionVariant::ChoralMrrrglr => choral_mrrrglr::golden_event_handlers(),
            MinionVariant::ColossusOfTheSun => colossus_of_the_sun::golden_event_handlers(),
            MinionVariant::DarkgazeElder => darkgaze_elder::golden_event_handlers(),
            MinionVariant::DreadAdmiralEliza => dread_admiral_eliza::golden_event_handlers(),
            MinionVariant::ElementalOfSurprise => elemental_of_surprise::golden_event_handlers(),
            MinionVariant::EternalSummoner => eternal_summoner::golden_event_handlers(),
            MinionVariant::FamishedFelbat => famished_felbat::golden_event_handlers(),
            MinionVariant::Felstomper => felstomper::golden_event_handlers(),
            MinionVariant::FleetAdmiralTethys => fleet_admiral_tethys::golden_event_handlers(),
            MinionVariant::FoeReaper4000 => foe_reaper_4000::golden_event_handlers(),
            MinionVariant::GentleDjinni => gentle_djinni::golden_event_handlers(),
            MinionVariant::Ghastcoiler => ghastcoiler::golden_event_handlers(),
            MinionVariant::GoldrinnTheGreatWolf => goldrinn_the_great_wolf::golden_event_handlers(),
            MinionVariant::GreaseBot => grease_bot::golden_event_handlers(),
            MinionVariant::GretaGoldGun => greta_gold_gun::golden_event_handlers(),
            MinionVariant::ImpMama => imp_mama::golden_event_handlers(),
            MinionVariant::KalecgosArcaneAspect => kalecgos_arcane_aspect::golden_event_handlers(),
            MinionVariant::LieutenantGarr => lieutenant_garr::golden_event_handlers(),
            MinionVariant::Maexxna => maexxna::golden_event_handlers(),
            MinionVariant::MantidQueen => mantid_queen::golden_event_handlers(),
            MinionVariant::MechaJaraxxus => mecha_jaraxxus::golden_event_handlers(),
            MinionVariant::Murky => murky::golden_event_handlers(),
            MinionVariant::NadinaTheRed => nadina_the_red::golden_event_handlers(),
            MinionVariant::NosyLooter => nosy_looter::golden_event_handlers(),
            MinionVariant::OctosariWrapGod => octosari_wrap_god::golden_event_handlers(),
            MinionVariant::OmegaBuster => omega_buster::golden_event_handlers(),
            MinionVariant::OrgozoaTheTender => orgozoa_the_tender::golden_event_handlers(),
            MinionVariant::PolarizingBeatboxer => polarizing_beatboxer::golden_event_handlers(),
            MinionVariant::RelentlessMurGhoul => relentless_mur_ghoul::golden_event_handlers(),
            MinionVariant::RockRock => rock_rock::golden_event_handlers(),
            MinionVariant::SeafoodSlinger => seafood_slinger::golden_event_handlers(),
            MinionVariant::SisterDeathwhisper => sister_deathwhisper::golden_event_handlers(),
            MinionVariant::TeaMasterTheotar => tea_master_theotar::golden_event_handlers(),
            MinionVariant::TheBoogieMonster => the_boogie_monster::golden_event_handlers(),
            MinionVariant::TheWalkingFort => the_walking_fort::golden_event_handlers(),
            MinionVariant::TidemistressAthissa => tidemistress_athissa::golden_event_handlers(),
            MinionVariant::UtherTheLightbringer => uther_the_lightbringer::golden_event_handlers(),
            MinionVariant::Warpwing => warpwing::golden_event_handlers(),
            MinionVariant::YoungMurkEye => young_murk_eye::golden_event_handlers(),
            MinionVariant::ZappSlywick => zapp_slywick::golden_event_handlers(),
            MinionVariant::Amalgadon => amalgadon::golden_event_handlers(),
            MinionVariant::ArgentBraggart => argent_braggart::golden_event_handlers(),
            MinionVariant::CaptainSanders => captain_sanders::golden_event_handlers(),
            MinionVariant::ChampionOfSargeras => champion_of_sargeras::golden_event_handlers(),
            MinionVariant::GraniteGuardian => granite_guardian::golden_event_handlers(),
            MinionVariant::KingVarian => king_varian::golden_event_handlers(),
            MinionVariant::MoiraBronzebeard => moira_bronzebeard::golden_event_handlers(),
            MinionVariant::ObsidianRavager => obsidian_ravager::golden_event_handlers(),
            MinionVariant::PapaBear => papa_bear::golden_event_handlers(),
            MinionVariant::RecurringNightmare => recurring_nightmare::golden_event_handlers(),
            MinionVariant::SanguineChampion => sanguine_champion::golden_event_handlers(),
            MinionVariant::SeaWitchZarJira => sea_witch_zar_jira::golden_event_handlers(),
            MinionVariant::TheBoommobile => the_boommobile::golden_event_handlers(),
            MinionVariant::TideOracleMorgl => tide_oracle_morgl::golden_event_handlers(),
            MinionVariant::Amalgam => amalgam::golden_event_handlers(),
            MinionVariant::AnnoyOSpawn => annoy_o_spawn::golden_event_handlers(),
            MinionVariant::BackpiggyImp => backpiggy_imp::golden_event_handlers(),
            MinionVariant::Baltharak => baltharak::golden_event_handlers(),
            MinionVariant::Crab => crab::golden_event_handlers(),
            MinionVariant::Cubling => cubling::golden_event_handlers(),
            MinionVariant::DamagedGolem => damaged_golem::golden_event_handlers(),
            MinionVariant::Devilsaur => devilsaur::golden_event_handlers(),
            MinionVariant::DiabloLordOfTerror => diablo_lord_of_terror::golden_event_handlers(),
            MinionVariant::EmperorCobra => emperor_cobra::golden_event_handlers(),
            MinionVariant::FieryImp => fiery_imp::golden_event_handlers(),
            MinionVariant::FishOfNZoth => fish_of_n_zoth::golden_event_handlers(),
            MinionVariant::GoldenMonkey => golden_monkey::golden_event_handlers(),
            MinionVariant::HalfShell => half_shell::golden_event_handlers(),
            MinionVariant::HelpingHand => helping_hand::golden_event_handlers(),
            MinionVariant::Hyena => hyena::golden_event_handlers(),
            MinionVariant::Imp => imp::golden_event_handlers(),
            MinionVariant::MagtheridonPrime => magtheridon_prime::golden_event_handlers(),
            MinionVariant::Mechapony => mechapony::golden_event_handlers(),
            MinionVariant::Mechorse => mechorse::golden_event_handlers(),
            MinionVariant::Microbot => microbot::golden_event_handlers(),
            MinionVariant::OnyxianWhelp => onyxian_whelp::golden_event_handlers(),
            MinionVariant::OzumatSTentacle => ozumat_s_tentacle::golden_event_handlers(),
            MinionVariant::Plant => plant::golden_event_handlers(),
            MinionVariant::Rat => rat::golden_event_handlers(),
            MinionVariant::Robosaur => robosaur::golden_event_handlers(),
            MinionVariant::RustedReggie => rusted_reggie::golden_event_handlers(),
            MinionVariant::Shudderling => shudderling::golden_event_handlers(),
            MinionVariant::SkyPirate => sky_pirate::golden_event_handlers(),
            MinionVariant::Smolderwing => smolderwing::golden_event_handlers(),
            MinionVariant::Snake => snake::golden_event_handlers(),
            MinionVariant::StoneElemental => stone_elemental::golden_event_handlers(),
            MinionVariant::Tabbycat => tabbycat::golden_event_handlers(),
            MinionVariant::TentacleOfOctosari => tentacle_of_octosari::golden_event_handlers(),
            MinionVariant::WaterDroplet => water_droplet::golden_event_handlers(),
        }
    }
